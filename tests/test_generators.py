...
def test_transaction_descriptions(transactions: List[Dict[str, Any]]) -> None:
    # Тестирование стандартных данных
...
def test_transaction_descriptions_sample(sample_description: list) -> None:
    # Тестирование обработки описаний при отсутствии или пропуске данных
...
# Параметризованный тест для проверки разных случаев
...
def test_transaction_descriptions_simple(data: List[Dict[str, Any]], expected: list) -> None:
