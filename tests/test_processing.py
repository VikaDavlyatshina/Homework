...
def test_filter_by_state_default_with_fixture(example_of_transactions: List[Transaction]) -> None:
...
def test_filter_by_state_with_fixture(example_of_transactions: List[Transaction]) -> None:
...
def test_filter_by_state_nonexistent_with_fixture(example_of_transactions: List[Transaction]) -> None:
...
def test_sort_by_date_with_fixture(example_of_transactions: List[Transaction]) -> None:
...
def test_sort_by_date_ascending_with_fixture(example_of_transactions: List[Transaction]) -> None:
